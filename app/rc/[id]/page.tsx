...
export default function RCPage({ params }: { params: { id: string } }) {
  ...
  if (!passage) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center p-6 max-w-md mx-auto">
        ...
        <button onClick={() => router.push('/history')} className="px-4 py-2 bg-[#E5E5E3] hover:bg-gray-300 rounded text-xs font-mono">
          Back to History
        </button>
      </div>
    );
